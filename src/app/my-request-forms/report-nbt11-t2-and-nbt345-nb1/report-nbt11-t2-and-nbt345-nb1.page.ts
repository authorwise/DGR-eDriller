...
import formData from "../../../json/reportNBT11T2AndNBT345NB1ForMobile.json";
...
@Component({
  selector: "app-report-nbt11-t2-and-nbt345-nb1",
  templateUrl: "./report-nbt11-t2-and-nbt345-nb1.page.html",
  styleUrls: ["./report-nbt11-t2-and-nbt345-nb1.page.scss"],
})
export class ReportNBT11T2AndNBT345NB1Page implements OnInit, AfterViewInit {
