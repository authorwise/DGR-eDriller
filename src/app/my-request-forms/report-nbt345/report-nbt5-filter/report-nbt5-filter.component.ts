...
import formData from '../../../../json/reportNBT5Filter.json'
...
@Component({
  selector: 'app-report-nbt5-filter',
  templateUrl: './report-nbt5-filter.component.html',
  styleUrls: ['./report-nbt5-filter.component.scss'],
})
export class ReportNbt5FilterComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    if (this.dataEdit) {
      setTimeout(() => {
        ...
        this.validateForm.get('filterDiameter')?.setValue(this.dataEdit.filterDiameter);
        this.validateForm
          .get('filterFrom')
          ?.setValue(this.dataEdit.filterFrom);
        this.validateForm
          .get('filterSize')
          ?.setValue(this.dataEdit.filterSize);
          this.validateForm
          .get('filterTo')
          ?.setValue(this.dataEdit.filterTo);
  ...
  submitForm() {
    ...
    this.loadingCtrl
      ...
      .then(async loadingEl => {
        ...
        const config = getApiGEDrillerConfigByKey(this.dataEdit ? "update_reportNBT5Filter" : "reportNBT5Filter") as any;
        ...
        .subscribe(resData => {
          ...
          console.log('reportNBT5Filter resData', resData);
